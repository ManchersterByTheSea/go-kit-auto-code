...
func main() {
	...
	method := "New"
	METHOD := "POST"
	router := "/sys-merchant/v1/game"
	filename := "merchant_game_new.go"
	gw := "sys"
	name_method := "game new"
