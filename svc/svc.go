...
const (
	...
	template9 = "\t{{Name}}{{method}}(ctx context.Context, reqproto *staffproto.{{Name}}{{method}}ReqProto) (*staffproto.{{Name}}{{method}}RespProto, error)"

	templateA = "package grpc\n\nimport (\n\t\"xtech-kit/proto/staff/v1\"\n)\n\nfunc New{{Name}}{{method}}ReqProto() *staffproto.{{Name}}{{method}}ReqProto {\n\treturn &staffproto.{{Name}}{{method}}ReqProto{\n\t}\n}\n"
	templateB = "package endpoint\n\nimport (\n\t\"context\"\n\n\t\"xtech-kit/proto/staff/v1\"\n\t\"xtech-kit/svc/staff-svc/pkg/staff/service\"\n\n\t\"github.com/go-kit/kit/endpoint\"\n)\n\nfunc Encode{{Name}}{{method}}Request(ctx context.Context, req interface{}) (interface{}, error) {\n\treqProto := req.(*staffproto.{{Name}}{{method}}ReqProto)\n\n\treturn reqProto, nil\n}\n\nfunc Decode{{Name}}{{method}}Request(ctx context.Context, req interface{}) (interface{}, error) {\n\treqProto := req.(*staffproto.{{Name}}{{method}}ReqProto)\n\n\treturn reqProto, nil\n}\n\nfunc Encode{{Name}}{{method}}Response(ctx context.Context, resp interface{}) (interface{}, error) {\n\trespProto := resp.(*staffproto.{{Name}}{{method}}RespProto)\n\n\treturn respProto, nil\n}\n\nfunc Decode{{Name}}{{method}}Response(ctx context.Context, resp interface{}) (interface{}, error) {\n\trespProto := resp.(*staffproto.{{Name}}{{method}}RespProto)\n\n\treturn respProto, nil\n}\n\nfunc Make{{Name}}{{method}}Endpoint(service service.StaffSvcService) endpoint.Endpoint {\n\treturn func(ctx context.Context, req interface{}) (interface{}, error) {\n\t\treqProto := req.(*staffproto.{{Name}}{{method}}ReqProto)\n\n\t\trespProto, err := service.{{Name}}{{method}}(ctx, reqProto)\n\n\t\tif err != nil {\n\t\t\treturn nil, err\n\t\t}\n\n\t\treturn respProto, nil\n\t}\n}\n\n// for grpc client\nfunc (u StaffSvcEndpoints) {{Name}}{{method}}(ctx context.Context, reqproto *staffproto.{{Name}}{{method}}ReqProto) (*staffproto.{{Name}}{{method}}RespProto, error) {\n\tresp, err := u.{{Name}}{{method}}Endpoint(ctx, reqproto)\n\n\tif err != nil {\n\t\treturn nil, err\n\t}\n\n\treturn resp.(*staffproto.{{Name}}{{method}}RespProto), nil\n}\n"
	templateC = "package grpc\n\nimport (\n\t\"context\"\n\n\t\"xtech-kit/proto/staff/v1\"\n)\n\nfunc (p *grpcServer) {{Name}}{{method}}(ctx context.Context, req *staffproto.{{Name}}{{method}}ReqProto) (*staffproto.{{Name}}{{method}}RespProto, error) {\n\t_, resp, err := p.{{name}}{{method}}Handler.ServeGRPC(ctx, req)\n\n\tif err != nil {\n\t\treturn nil, err\n\t}\n\n\trespProto := resp.(*staffproto.{{Name}}{{method}}RespProto)\n\n\treturn respProto, nil\n}\n"
	templateD = "package service\n\nimport (\n\t\"context\"\n\n\t\"xtech-kit/const\"\n\t\"xtech-kit/error\"\n\t\"xtech-kit/proto/staff/v1\"\n\tdbrepository \"xtech-kit/svc/staff-svc/pkg/staff/repository/database\"\n\n\t\"github.com/xianyu-tech/tlog\"\n\t\"github.com/xianyu-tech/util/log\"\n)\n\nfunc (p *basicStaffSvcService) {{Name}}{{method}}(ctx context.Context, reqproto *staffproto.{{Name}}{{method}}ReqProto) (*staffproto.{{Name}}{{method}}RespProto, error) {\n\tdefer func() {\n\t\tif rec := recover(); rec != nil {\n\t\t\terrMsg := tlog.Error(\"staff auth fetch (%d, %s) err (recover %v).\", reqproto.GetStaffId(), reqproto.GetIdentifier(), logutil.PrintPanic())\n\n\t\t\ttlog.AsyncSend(tlog.NewRawLogError(comconst.ErrPanicRecovery(\"staff auth fetch\"), errMsg))\n\t\t}\n\t}()\n\n\n\t{{name}}{{method}}RespProto := &staffproto.{{Name}}{{method}}RespProto{\n\t\tErrCode: errconst.COMMON_API_ERROR_OK,\n\t}\n\treturn {{name}}{{method}}RespProto, nil\n}\n"
)
